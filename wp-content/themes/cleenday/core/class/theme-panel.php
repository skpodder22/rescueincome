...
if (!class_exists('Wgl_Theme_Panel')) {
    ...
    class Wgl_Theme_Panel
    {
        ...
        {
            add_menu_page (
                esc_html__('WebGeniusLab', 'cleenday'),
                esc_html__('WebGeniusLab', 'cleenday'),
            ...
            $submenu = [];
            $submenu[] = [
                esc_html__('Welcome', 'cleenday'), // page_title
                esc_html__('Welcome', 'cleenday'), // menu_title
                'manage_options', // capability
            ...
            if (current_user_can( 'activate_plugins' )):
                $submenu[] = [
                    esc_html__('Theme Plugins', 'cleenday'), // page_title
                    esc_html__('Theme Plugins', 'cleenday'), // menu_title
            ...
            $submenu[] = [
                esc_html__('Requirements', 'cleenday'), // page_title
                esc_html__('Requirements', 'cleenday'), // menu_title
                'edit_posts', // capability
            ...
            $submenu[] = [
                esc_html__('Activate Theme', 'cleenday'), // page_title
                esc_html__('Activate Theme', 'cleenday'), // menu_title
                'edit_posts', // capability
            ...
            $submenu[] = [
                esc_html__('Help Center', 'cleenday'), // page_title
                esc_html__('Help Center', 'cleenday'), // menu_title
                'edit_posts', // capability
            ...
            if ( class_exists( 'Cleenday_Core' ) ) {
                $submenu[] = [
                    esc_html__('Theme Options', 'cleenday'), // page_title
                    esc_html__('Theme Options', 'cleenday'), // menu_title
                    'edit_posts', // capability
