...
<li class="wgl_mini-cart_flex">
    ...
    <div class="wgl_mini-cart_image">
        <a href="<?php echo esc_url( $product->get_permalink() ); ?>">
            ...
            if(function_exists('aq_resize')){
                ...
                echo Cleenday_Theme_Helper::render_html($product->get_image()); // PHPCS:Ignore WordPress.Security.EscapeOutput.OutputNotEscaped
            }
    ...
    <?php endif; ?>
        <p class="price">
            <?php echo Cleenday_Theme_Helper::render_html( $product->get_price_html() ); // PHPCS:Ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
        </p>
    </div>
