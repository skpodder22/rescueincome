	...
	class Redux_Border extends Redux_Field {
		...
		public function render() {
			...
			if ( ! isset( $this->field['all'] ) || true !== $this->field['all'] ) {
				...
				if ( true === $this->field['top'] ) {
					echo '<div class="field-border-input input-prepend">
                            ...
                            <input type="text" class="redux-border-top redux-border-input mini ' . esc_attr( $this->field['class'] ) . '" placeholder="' . esc_html__( 'Top', 'cleenday-core' ) . '" rel="' . esc_attr( $this->field['id'] ) . '-top" value="' . esc_attr( $this->value['top'] ) . '">
                         </div>';
				}
				...
				if ( true === $this->field['right'] ) {
					echo '<div class="field-border-input input-prepend">
                            ...
                            <input type="text" class="redux-border-right redux-border-input mini ' . esc_attr( $this->field['class'] ) . '" placeholder="' . esc_html__( 'Right', 'cleenday-core' ) . '" rel="' . esc_attr( $this->field['id'] ) . '-right" value="' . esc_attr( $this->value['right'] ) . '">
                        </div>';
				}
				...
				if ( true === $this->field['bottom'] ) {
					echo '<div class="field-border-input input-prepend">
                            ...
                            <input type="text" class="redux-border-bottom redux-border-input mini ' . esc_attr( $this->field['class'] ) . '" placeholder="' . esc_html__( 'Bottom', 'cleenday-core' ) . '" rel="' . esc_attr( $this->field['id'] ) . '-bottom" value="' . esc_attr( $this->value['bottom'] ) . '">
                        </div>';
				}
				...
				if ( true === $this->field['left'] ) {
					echo '<div class="field-border-input input-prepend">
                            ...
                            <input type="text" class="redux-border-left redux-border-input mini ' . esc_attr( $this->field['class'] ) . '" placeholder="' . esc_html__( 'Left', 'cleenday-core' ) . '" rel="' . esc_attr( $this->field['id'] ) . '-left" value="' . esc_attr( $this->value['left'] ) . '">
                        </div>';
				}
			}
			...
			if ( false !== $this->field['style'] ) {
				...
				echo '<select data-placeholder="' . esc_html__( 'Border style', 'cleenday-core' ) . '" id="' . esc_attr( $this->field['id'] ) . '[border-style]" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[border-style]" class="tips redux-border-style ' . esc_attr( $this->field['class'] ) . '" rows="6" data-id="' . esc_attr( $this->field['id'] ) . '"' . esc_attr( $select2_data ) . '>';
