	...
	class Redux_Slides extends Redux_Field {
		...
		public function set_defaults() {
			$defaults = array(
				...
				'content_title' => __( 'Slide', 'cleenday-core' ),
			);
		...
		public function render() {
			...
			echo '<div class="redux-slides-accordion" data-new-content-title="' . esc_attr( sprintf( __( 'New %s', 'cleenday-core' ), $this->field['content_title'] ) ) . '">';
			...
			if ( isset( $this->value ) && is_array( $this->value ) && ! empty( $this->value ) ) {
				...
				foreach ( $slides as $slide ) {
					...
					echo '<span class="button media_upload_button" id="add_' . esc_attr( $x ) . '">' . esc_html__( 'Upload', 'cleenday-core' ) . '</span>';
					...
					echo '<span
							...
							esc_html__( 'Remove', 'cleenday-core' ) . '</span>';
					...
					$placeholder = ( isset( $this->field['placeholder']['title'] ) ) ? esc_attr( $this->field['placeholder']['title'] ) : __( 'Title', 'cleenday-core' );
					echo '<li>';
					echo '<input
					...
					if ( $this->field['show']['description'] ) {
						$placeholder = ( isset( $this->field['placeholder']['description'] ) ) ? esc_attr( $this->field['placeholder']['description'] ) : __( 'Description', 'cleenday-core' );
						echo '<li>';
						echo '<textarea
					...
					$placeholder = ( isset( $this->field['placeholder']['url'] ) ) ? esc_attr( $this->field['placeholder']['url'] ) : __( 'URL', 'cleenday-core' );
					...
					echo '<li>';
					echo '<a href="javascript:void(0);" class="button deletion redux-slides-remove">' . esc_html__( 'Delete', 'cleenday-core' ) . '</a>';
					echo '</li>';
			...
			if ( 0 === $x ) {
				...
				echo '<span class="redux-slides-header">' . esc_html( sprintf( __( 'New %s', 'cleenday-core' ), esc_attr( $this->field['content_title'] ) ) ) . '</span>';
				echo '</h3>';
				echo '<div>';
				...
				echo '<span class="button remove-image' . esc_attr( $hide ) . '" id="reset_' . esc_attr( $x ) . '" rel="' . esc_attr( $this->parent->args['opt_name'] . '[' . $this->field['id'] ) . '][attachment_id]">' . esc_html__( 'Remove', 'cleenday-core' ) . '</span>';
			...
			echo '<a href="javascript:void(0);" class="button redux-slides-add button-primary" rel-id="' . esc_attr( $this->field['id'] ) . '-ul" rel-name="' . esc_attr( $this->field['name'] . '[title][]' . $this->field['name_suffix'] ) . '">' . esc_html( sprintf( __( 'Add %s', 'cleenday-core' ), esc_html( $this->field['content_title'] ) ) ) . '</a>';
			echo '<br/>';
		}
