	...
	class Redux_Background extends Redux_Field {
		...
		public function render() {
			...
			if ( $this->field['background-image'] ) {
				if ( true === $this->field['background-repeat'] ) {
					$array = array(
						...
						'repeat'    => esc_html__( 'Repeat All', 'cleenday-core' ),
						'repeat-x'  => esc_html__( 'Repeat Horizontally', 'cleenday-core' ),
						'repeat-y'  => esc_html__( 'Repeat Vertically', 'cleenday-core' ),
						'inherit'   => esc_html__( 'Inherit', 'cleenday-core' ),
					);

					echo '<select id="' . esc_attr( $this->field['id'] ) . '-repeat-select" data-placeholder="' . esc_html__( 'Background Repeat', 'cleenday-core' ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-repeat]" class="redux-select-item redux-background-input redux-background-repeat ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $select2_data ) . '>';
					echo '<option></option>';
				...
				if ( true === $this->field['background-clip'] ) {
					$array = array(
						'inherit'     => esc_html__( 'Inherit', 'cleenday-core' ),
						'border-box'  => esc_html__( 'Border Box', 'cleenday-core' ),
						'content-box' => esc_html__( 'Content Box', 'cleenday-core' ),
						'padding-box' => esc_html__( 'Padding Box', 'cleenday-core' ),
					);

					echo '<select id="' . esc_attr( $this->field['id'] ) . '-clip-select" data-placeholder="' . esc_html__( 'Background Clip', 'cleenday-core' ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-clip]" class="redux-select-item redux-background-input redux-background-clip ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $select2_data ) . '>';
					echo '<option></option>';
				...
				if ( true === $this->field['background-origin'] ) {
					...
					echo '<select id="' . esc_attr( $this->field['id'] ) . '-origin-select" data-placeholder="' . esc_html__( 'Background Origin', 'cleenday-core' ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-origin]" class="redux-select-item redux-background-input redux-background-origin ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $select2_data ) . '>';
					echo '<option></option>';
				...
				if ( true === $this->field['background-size'] ) {
					...
					echo '<select id="' . esc_attr( $this->field['id'] ) . '-size-select" data-placeholder="' . esc_html__( 'Background Size', 'cleenday-core' ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-size]" class="redux-select-item redux-background-input redux-background-size ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $select2_data ) . '>';
					echo '<option></option>';
				...
				if ( true === $this->field['background-position'] ) {
					$array = array(
						'left top'      => esc_html__( 'Left Top', 'cleenday-core' ),
						'left center'   => esc_html__( 'Left center', 'cleenday-core' ),
						'left bottom'   => esc_html__( 'Left Bottom', 'cleenday-core' ),
						'center top'    => esc_html__( 'Center Top', 'cleenday-core' ),
						'center center' => esc_html__( 'Center Center', 'cleenday-core' ),
						'center bottom' => esc_html__( 'Center Bottom', 'cleenday-core' ),
						'right top'     => esc_html__( 'Right Top', 'cleenday-core' ),
						'right center'  => esc_html__( 'Right center', 'cleenday-core' ),
						'right bottom'  => esc_html__( 'Right Bottom', 'cleenday-core' ),
					);
			...
			if ( $this->field['background-image'] ) {
				...
				$placeholder = isset( $this->field['placeholder'] ) ? $this->field['placeholder'] : esc_html__( 'No media selected', 'cleenday-core' );
				...
				echo '<span class="button redux-background-upload" id="' . esc_attr( $this->field['id'] ) . '-media">' . esc_html__( 'Upload', 'cleenday-core' ) . '</span>';
				...
				echo '<span class="button removeCSS redux-remove-background' . esc_attr( $hide ) . '" id="reset_' . esc_attr( $this->field['id'] ) . '" rel="' . esc_attr( $this->field['id'] ) . '">' . esc_html__( 'Remove', 'cleenday-core' ) . '</span>';
