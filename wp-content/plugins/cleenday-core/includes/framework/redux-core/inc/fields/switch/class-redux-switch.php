...
if ( ! class_exists( 'Redux_Switch', false ) ) {
	...
	class Redux_Switch extends Redux_Field {
		...
		public function render() {
			...
			// Label ON.
			$this->field['on'] = isset( $this->field['on'] ) ? $this->field['on'] : esc_html__( 'On', 'cleenday-core' );

			// Label OFF.
			$this->field['off'] = isset( $this->field['off'] ) ? $this->field['off'] : esc_html__( 'Off', 'cleenday-core' );
