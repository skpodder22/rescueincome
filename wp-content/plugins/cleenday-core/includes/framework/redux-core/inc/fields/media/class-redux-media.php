	...
	class Redux_Media extends Redux_Field {
		...
		public function set_defaults() {
			...
			$defaults = array(
				...
				'url'          => true,
				'alt'          => '',
				'placeholder'  => esc_html__( 'No media selected', 'cleenday-core' ),
				'readonly'     => true,
				'class'        => '',
			);
		...
		public function render() {
			...
			echo '<span class="button media_upload_button" id="' . esc_attr( $this->field['id'] ) . '-media">' . esc_html__( 'Upload', 'cleenday-core' ) . '</span>';
			...
			echo '<span class="button remove-image' . esc_attr( $hide ) . '" id="reset_' . esc_attr( $this->field['id'] ) . '" rel="' . esc_attr( $this->field['id'] ) . '">' . esc_html__( 'Remove', 'cleenday-core' ) . '</span>';
			echo '</div>';
