...
if ( ! class_exists( 'Redux_Import_Export', false ) ) {
	...
	class Redux_Import_Export extends Redux_Field {
		...
		public function render() {
			...
			?>
			<h4><?php esc_html_e( 'Import Options', 'cleenday-core' ); ?></h4>
			<p>
				<a
					href="javascript:void(0);"
					id="redux-import-code-button"
					class="button-secondary">
					<?php esc_html_e( 'Import from Clipboard', 'cleenday-core' ); ?>
				</a>
				...
				<a
					...
					class="button-secondary">
					<?php esc_html_e( 'Import from URL', 'cleenday-core' ); ?>
				</a>
				...
				<a
					...
					class="button-secondary">
					<?php esc_html_e( 'Upload file', 'cleenday-core' ); ?><span></span>
				</a>
			...
			<div id="redux-import-code-wrapper">
				<p class="description" id="import-code-description">
					...
					<?php echo esc_html( apply_filters( 'redux-import-file-description', esc_html__( 'Paste your clipboard data here.', 'cleenday-core' ) ) ); ?>
				</p>
				<textarea
			...
			<div id="redux-import-link-wrapper">
				<p class="description" id="import-link-description">
					<?php // phpcs:ignore WordPress.NamingConventions.ValidHookName ?>
					<?php echo esc_html( apply_filters( 'redux-import-link-description', esc_html__( 'Input the URL to another sites options set and hit Import to load the options from that site.', 'cleenday-core' ) ) ); ?>
				</p>
				<input
			...
			<p id="redux-import-action">
				<input
					...
					value="<?php esc_html_e( 'Import', 'cleenday-core' ); ?>">&nbsp;&nbsp;
				<span>
					<?php // phpcs:ignore WordPress.NamingConventions.ValidHookName ?>
					<?php echo esc_html( apply_filters( 'redux-import-warning', esc_html__( 'WARNING! This will overwrite all existing option values, please proceed with caution!', 'cleenday-core' ) ) ); ?>
				</span>
			</p>
			<div class="hr">
				<div class="inner">
			...
			<h4><?php esc_html_e( 'Export Options', 'cleenday-core' ); ?></h4>
			<div class="redux-section-desc">
				<p class="description">
					<?php // phpcs:ignore WordPress.NamingConventions.ValidHookName ?>
					<?php echo esc_html( apply_filters( 'redux-backup-description', esc_html__( 'Here you can copy/download your current option settings. Keep this safe as you can use it as a backup should anything go wrong, or you can use it to restore your settings on this site (or any other site).', 'cleenday-core' ) ) ); ?>
				</p>
			</div>
			...
			<p>
				<button id="redux-export-code-copy" class="button-secondary"
						...
						data-copy="<?php esc_attr_e( 'Copy to Clipboard', 'cleenday-core' ); ?>"
						data-copied="<?php esc_attr_e( 'Copied!', 'cleenday-core' ); ?>">
					<?php esc_html_e( 'Copy to Clipboard', 'cleenday-core' ); ?>
				</button>
				<a href="<?php echo esc_url( $link ); ?>" id="redux-export-code-dl" class="button-primary">
					<?php esc_html_e( 'Export File', 'cleenday-core' ); ?>
				</a>
				<a href="javascript:void(0);" id="redux-export-link" class="button-secondary"
				   data-copy="<?php esc_attr_e( 'Copy Export URL', 'cleenday-core' ); ?>"
				   data-copied="<?php esc_attr_e( 'Copied!', 'cleenday-core' ); ?>"
				   data-url="<?php echo esc_url( $link ); ?>">
					<?php esc_html_e( 'Copy Export URL', 'cleenday-core' ); ?>
				</a>
			</p>
			<p></p>
