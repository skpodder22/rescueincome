...
if ( ! class_exists( 'Redux_Validation_Comma_Numeric', false ) ) {
	...
	class Redux_Validation_Comma_Numeric extends Redux_Validate {
		...
		public function validate() {
			...
			$this->field['msg'] = ( isset( $this->field['msg'] ) ) ? $this->field['msg'] : esc_html__( 'You must provide a comma separated list of numerical values for this option.', 'cleenday-core' );
