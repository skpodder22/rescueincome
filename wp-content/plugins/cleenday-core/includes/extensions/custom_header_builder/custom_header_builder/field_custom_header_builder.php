        ...
        public function render() {
           ...
           foreach ( $temp as $k => $v ) {
            ...
            if ( $sortlists ) {
                ...
                echo '</fieldset>';
                echo '<div class="overlay_header" style="display: none;"><h2><a href="#cleenday_set-opt-js-preset">'.esc_html__('Select preset for start editing', 'cleenday-core').'</a></h2></div>';
                // Modal Options items
                ?>
