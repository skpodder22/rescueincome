...
function wpmlm_password_settings() {
    ...
    <div class="panel-border-heading">
        <h4><i class="fa fa-cog" aria-hidden="true"></i> <?php _e('Password Settings','wpmlm-unilevel'); ?></h4>
    </div>
    <div id="general-settings">
        <div class="panel-border col-md-12">
            <div   id="exTab4">
                <div class="col-md-3 ">
                    ...
                    <ul class="nav nav-tabs tabs-left">
                        ...
                        <li class="active"><a href="#change-password" data-toggle="tab"><?php _e('Change User Password','wpmlm-unilevel'); ?></a></li>

                        <li><a href="#send-tran-pass" data-toggle="tab"><?php _e('Send Transaction Password','wpmlm-unilevel'); ?></a></li>
                        <li><a href="#change-tran-pass" data-toggle="tab"><?php _e('Change Admin Transaction','wpmlm-unilevel'); ?><br> <?php _e('Password','wpmlm-unilevel'); ?></a></li>
                    </ul>
                </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="change-password">
                            ...
                            <div class="panel-heading">
                                <h4><i class="fa fa-external-link-square"></i> <span> <?php _e('Change User Password','wpmlm-unilevel'); ?></span></h4>
                            ...
                            <div class="panel-border">
                                ...
                                <form id="user-password-form" class="form-horizontal " method="post">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 user-dt" for="user_name"><?php _e('Username','wpmlm-unilevel'); ?>:</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 user-dt" for="password_user"><?php _e('New Password','wpmlm-unilevel'); ?>:</label>
                                        <div class="col-md-6">
                        ...
                        <div class="tab-pane" id="send-tran-pass">
                            ...
                            <div class="panel-heading">
                                <h4><i class="fa fa-external-link-square"></i> <span> <?php _e('Send Transaction Password','wpmlm-unilevel'); ?></span></h4>
                    
                </div>
                            <div class="panel-border">
                                <div class="submit_message"></div>
                                <p style="color: #31afde"><?php _e("Note : Transaction password will be sent to user's Registered Email id",'wpmlm-unilevel'); ?></p>
                                <form id="send-tran-pass-form" class="form-horizontal " method="post">
                                    <div class="form-group">
                                        <label class="control-label col-md-3 user-dt" for="tran_user_name"><?php _e('User Name','wpmlm-unilevel'); ?>:</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group"> 
                                        <div class="col-sm-offset-3 col-sm-6">
                                            ...
                                            <button id="send-tran-pass-button" type="submit" class="btn btn-danger send-tran-pass-button" > <?php _e('Send Password','wpmlm-unilevel'); ?></button>
           ...
           <div class="panel panel-default">
                            ...
                            <div class="panel-heading">
                                <h4><i class="fa fa-external-link-square"></i> <span> <?php _e('Change Admin Transaction Password','wpmlm-unilevel'); ?></span></h4>
                            ...
                            <div class="panel-border">
                                ...
                                <form id="change-tran-pass-form" class="form-horizontal " method="post">
                                    <div class="form-group">
                                        <label class="control-label col-md-3 user-dt" for="current_tran_pass"><?php _e('Current Password','wpmlm-unilevel'); ?>:</label>
                                        <div class="col-md-6">
                                            <input type="password" class="form-control admin_tran_input" name="current_tran_pass" id="current_tran_pass">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 user-dt" for="new_tran_pass"><?php _e('New Password','wpmlm-unilevel'); ?>:</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 user-dt" for="confirm_tran_pass"><?php _e('Confirm New Password','wpmlm-unilevel'); ?>:</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group"> 
                                        <div class="col-sm-offset-3 col-sm-6">
                                            ...
                                            <button id="change-tran-pass-button" type="submit" class="btn btn-danger change-tran-pass-button"> <?php _e('Update','wpmlm-unilevel'); ?></button>
